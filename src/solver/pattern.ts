  ...
  for (const t of boundryCells) {
    ...
    if (checkHorizontal121(t)) {
      safeToCheck = intersection(
        ...
        union(uncheckedNeighboringCells(t), uncheckedNeighboringCells(t + 2))
      );
      ...
      safeToCheck = intersection(
        ...
        union(
          uncheckedNeighboringCells(t),
          uncheckedNeighboringCells(t + 2 * width)
        )
      );
      ...
      safeToCheck = intersection(
        ...
        uncheckedNeighboringCells(t).concat(uncheckedNeighboringCells(t + 3))
      );
      ...
      safeToCheck = intersection(
        ...
        uncheckedNeighboringCells(t).concat(
          uncheckedNeighboringCells(t + 3 * width)
        )
      );
    }
